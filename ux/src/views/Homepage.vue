    ...
    <div class="cd-hero">
      ...
      <div class="cd-slider-nav">
        <nav class="navbar">
          <div class="tm-navbar-bg">
            ...
            <a class="navbar-brand text-uppercase" href="#"><i class="fa fa-picture-o tm-brand-icon" />Fluid Gallery</a>

            <button class="navbar-toggler hidden-lg-up" type="button" data-toggle="collapse" data-target="#tmNavbar">
              &#9776;
            </button>
            <div id="tmNavbar" class="collapse navbar-toggleable-md text-xs-center text-uppercase tm-navbar">
                      ...
                      <div class="tm-bg-white-translucent text-xs-left tm-textbox tm-2-col-textbox-2 tm-textbox-padding tm-textbox-padding-contact">
                        ...
                        <form action="index.html" method="post" class="tm-contact-form">
                          ...
                          <div class="form-group">
                            <input id="contact_name" type="text" name="contact_name" class="form-control" placeholder="Name" required>
                          </div>

                          <div class="form-group">
                            <input id="contact_email" type="email" name="contact_email" class="form-control" placeholder="Email" required>
                          </div>

                          <div class="form-group">
                            <textarea id="contact_message" name="contact_message" class="form-control" rows="5" placeholder="Message" required />
                          </div>
      ...
      <footer class="tm-footer">
        ...
        <div class="tm-social-icons-container text-xs-center">
          <a href="#" class="tm-social-link"><i class="fa fa-facebook" /></a>
          <a href="#" class="tm-social-link"><i class="fa fa-google-plus" /></a>
          <a href="#" class="tm-social-link"><i class="fa fa-twitter" /></a>
          <a href="#" class="tm-social-link"><i class="fa fa-behance" /></a>
