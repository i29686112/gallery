...
class FilmSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Film::factory()->create([
            ...
            'cover_image_path' => 'xtra400.jpg',
        ]);
        Film::factory()->create([
            'key_name' => 'e100',
            'name' => 'E100',
            'description' => 'e100 description',
            'cover_image_path' => 'e100.jpg',
        ]);
        Film::factory()->create([
            'key_name' => 'gold200',
            'name' => 'Gold 200',
            'description' => 'gold200 description',
            'cover_image_path' => 'gold200.jpg',
        ]);
        Film::factory()->create([
        ...
        Film::factory()->create([
            ...
            'cover_image_path' => '500t.jpg',
        ]);
        Film::factory()->create([
            'key_name' => '50d',
            'name' => '50D',
            'description' => '50d description',
            'cover_image_path' => '50d.jpg',
        ]);
        Film::factory()->create([
            'key_name' => 'ektar100',
            'name' => 'Ektar 100',
